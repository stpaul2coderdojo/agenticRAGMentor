...
![Agentic RAG Pipeline](https://github.com/stpaul2coderdojo/agenticRAGMentor/blob/main/Architecture%20Diagram%20RAG.png)) <!-- Add a reference to the PlantUML generated architecture diagram image if available -->
